    ...
    <div id="resume">
      <div className="titled-section-narrow">
        ...
        <div className="resume-content">
          ...
          <a className="bg-claret py-4 px-6 border-radius-4 text-slate-100 no-underline self-center" href="../../../assets/dale_chang_resume.pdf" target="_blank" rel="noreferrer">Download Resume</a>
        </div>
      </div>
    </div>
  )
