  ...
  const caadsContent = [<div className="work-item">
    <div className="work-item-md-content">
      ...
      <div className="technologies-used">
        ...
        <StaticImage src={"http://cdn-dalechang-dev.sfo3.digitaloceanspaces.com/python.png"} alt="Python" height={iconHeight} />
        ...
        <StaticImage src={"http://cdn-dalechang-dev.sfo3.digitaloceanspaces.com/d3js.png"} alt="D3JS Logo" height={iconHeight} />
        <StaticImage src={"http://cdn-dalechang-dev.sfo3.digitaloceanspaces.com/jupyter-notebook.png"} alt="Jupyter Notebook Logo" height={iconHeight} />
      </div>
    </div>
    <div className="work-item-md-content">
      <StaticImage src={"http://cdn-dalechang-dev.sfo3.digitaloceanspaces.com/caads-ui.png"} alt="CAADS UI" layout="constrained" />
